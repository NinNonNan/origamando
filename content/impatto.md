...
# <i class="fas fa-tree orange-icon"></i> Stato attuale

{{< forest-stats >}}

- <i class="fas fa-calendar-day orange-icon"></i> Punto di partenza del progetto: 19 Maggio 2026
- <i class="fas fa-seedling orange-icon"></i> Primo albero: albero fondativo di Origamando Forest

---

# <i class="fas fa-chart-pie orange-icon"></i> Composizione della foresta
...
# <i class="fas fa-flask orange-icon"></i> Filosofia del laboratorio

Il Professor Origami considera ogni albero un esperimento riuscito:
una piega del mondo reale verso una forma più sostenibile.
